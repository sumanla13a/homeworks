...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LambdaLibrary.countHighSalaryEmpLastNameEplus.apply(list));
		...
		// before the letter 'R'
		List<Employee> newList = LambdaLibrary.filterEmployeeMidSalary.apply(list);
		newList.forEach(e -> System.out.println(e.getFirstName().toUpperCase() + " " + e.getLastName().toUpperCase()));
